        ...
        <table className="productList">
          {this.props.invoice.productList && (
            <thead>
              <tr id="productListHeader">
                ...
                {!this.props.invoice.igst && <th className="pr-cgst">CGST</th>}
                {!this.props.invoice.igst && <th className="pr-sgst">SGST</th>}
          ...
          {this.props.invoice.total && (
            <tr className="invoiceTotalRow">
              ...
              {this.props.invoice.igst && (
                <td className="summary-igst">{this.props.invoice.igstTotal}</td>
              )}
              {!this.props.invoice.igst && (
                <td className="summary-cgst">{this.props.invoice.cgstTotal}</td>
              )}
              {!this.props.invoice.igst && (
                <td className="summary-sgst">{this.props.invoice.sgstTotal}</td>
              )}
              <td className="summary-total">{this.props.invoice.total}</td>
            </tr>
          )}
        </table>
        {this.props.invoice.total && (
          <div className="summary-totalInWords">
            {this.camelize(this.props.invoice.totalInWords)} only
          </div>
        )}
        <div id="disclaimer">
          <p>&nbsp;</p>
